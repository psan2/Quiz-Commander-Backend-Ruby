...
q9 =
  Question.create(
    ...
    question_type: 'text',
    question_content:
      'What kind of animal is Stimpy? Bonus point for the breed.',
...
q16 =
  Question.create(
    ...
    question_type: 'text',
    question_content:
      'Aside from Arnold, who is the only other character Helga falls for, briefly?',
...
q22 =
  Question.create(
    ...
    question_type: 'text',
    question_content:
      "Reggie and Otto's mom dies while they're very little - what was her name?",
...
t1 =
  Team.create(
    team_name: 'Demo Team 1', email: 'demoteam1@demo.com', password: 'password1'
  )
t2 =
  Team.create(
    team_name: 'Demo Team 2', email: 'demoteam2@demo.com', password: 'password2'
  )
t3 =
  Team.create(
    team_name: 'Demo Team 3', email: 'demoteam3@demo.com', password: 'password3'
  )
t4 =
  Team.create(
    team_name: 'Demo Team 4', email: 'demoteam4@demo.com', password: 'password4'
  )
t5 =
  Team.create(
    team_name: 'Demo Team 5', email: 'demoteam5@demo.com', password: 'password5'
  )

#create a quiznight
qn1 =
  QuizNight.create(
    quiz: qz1, date: Date.today, location: "The Queen's Head", pub_id: 10_092
  )
qn2 =
  QuizNight.create(
    quiz: qz1,
